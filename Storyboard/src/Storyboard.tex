...
\begin{document}
    ...
    %todo folgenden text überarbeiten
    %Als ich die obenstehende Auswahl an verschiedenen Farbpaletten zusammen hatte, habe ich diese anhand einer
    %Entscheidungsmatrix ausgewertet und mich so für eine Palette entschieden. Da Farben auf verschiedene Menschen
    %verschiedene Wirkungen haben, habe ich noch einige Klassenkameraden gefragt, was sie zu den verschiedenen
    %Farbpaletten meinen.\\
%
    %\textbf{Kriterien}%TODO kriterien definieren
    %\begin{itemize}
    %    \item Passt zum Thema \textrightarrow
    %    \item Kontrastwert \textrightarrow %TODO beschreiben wegen kontrastwert wie der gemessen wird und so
    %\end{itemize}
%
    %\textbf{Entscheidungsmatrix}\\
    %\begin{center}
    %    \begin{tabular}{ | p{3cm} | p{2cm} | p{2.5cm} | p{2cm} | p{2cm} | p{2cm} | p{1.5cm} | }
    %        \hline
    %        & \textbf{Passt zum Thema} & \textbf{Kontrastwert} & \textbf{Meinung Michael Schädler} & \textbf{Meinung Nico Nussmüller} & \textbf{Meinung Mattia Müggler} & \textbf{Total}\\ \hline
    %        \textbf{Farbpalette 1} & 1                        & 2                     & 3                                 & 4                                & 5                               & tot            \\ \hline
    %        \textbf{Farbpalette 2} & 1                        & 2                     & 3                                 & 4                                & 5                               & tot            \\ \hline
    %        \textbf{Farbpalette 2} & 1                        & 2                     & 3                                 & 4                                & 5                               & tot            \\ \hline
    %        \textbf{Farbpalette 2} & 1                        & 2                     & 3                                 & 4                                & 5                               & tot            \\ \hline
    %    \end{tabular}
    %\end{center}
    ...
    \includegraphics[width=\textwidth]{media/Bearbeitet}
